...
$products = array_values(array_filter($products, function ($product) {
    return getProductCategory($product) === "oli";
}));
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="container">
    <header class="header">
        <div>
            ...
            <h1>Daftar Harga & Stok Oli</h1>
            <p>Produk kategori Oli dengan stok yang terus diperbarui.</p>
        </div>
        <nav class="customer-menu">
            <a href="index.php" class="menu-item">Semua Produk</a>
            <a href="ban.php" class="menu-item">Ban</a>
            <a href="oli.php" class="menu-item active">Oli</a>
        </nav>
    </header>
    ...
    <div class="shop-layout">
        <aside class="shop-sidebar">
            <div class="sidebar-panel">
                ...
                <div class="category-list">
                    ...
                    <a href="ban.php" class="category-item">
                        <span>Ban</span>
                    </a>
                    <a href="oli.php" class="category-item active">
                        <span>Oli</span>
                    </a>
                </div>
            </div>
        ...
        <section class="products-section">
            <div class="category-cta-row">
                ...
                <a href="oli.php" class="category-cta oli-cta active">Oli</a>
            </div>

            <div class="products">
                <?php if (count($products) === 0): ?>
                    <p class="empty-state">Belum ada produk Oli.</p>
                <?php else: ?>
